...
public class TaskStats
{
    ...
    public TaskStats(
            ...
            @JsonProperty("completedDrivers") int totalSplits,
            @JsonProperty("completedDrivers") int queuedSplits,
            @JsonProperty("completedDrivers") int runningSplits,
            @JsonProperty("completedDrivers") int completedSplits,
